...
| PUT          | /api/order-items/{id}                | Update Item Quantity of an OrderItem       | Private |
| DELETE       | /api/order-items/{id}                | Delete an OrderItem                        | Private |
| GET          | /api/books/autofill/{isbn}           | Get book data by ISBN from external source | Admin   |
